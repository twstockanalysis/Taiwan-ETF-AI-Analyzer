# GoodCat character assets

These original gray-and-white GoodCat illustrations were generated for
...
2026-08-27, then converted from a chroma-key background to real alpha
transparency with the repository-local image workflow.
...
labels, result status, risks or warnings.
