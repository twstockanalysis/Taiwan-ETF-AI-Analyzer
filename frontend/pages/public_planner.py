...
from frontend.api_client import APIClientError, fetch_public_planner_baseline
    ...
    if submitted:
        ...
        if errors:
            ...
            try:
                ...
                with loading_state("正在計算現有持股與月份缺口..."):
                ...
                st.session_state["public_planner_result"] = result

    result = st.session_state.get("public_planner_result")
    if isinstance(result, dict):
        render_public_planner_result(result)
